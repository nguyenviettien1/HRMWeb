                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Vị trí</h2>
                            <div style="width:100%;position: relative;">
                                <a href="admin/vitri/them" class="btn btn-primary" style="right: 0 ;position: absolute;">Thêm mới</a>
                            </div>
                            <p class="pageheader-text">Position Detail</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Vị trí</li>
                                        <li class="breadcrumb-item"><a href="admin/vitri/danhsach" class="breadcrumb-link">Danh sách</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-weight:bold; background-color:yellow">Hệ số lương</th>
