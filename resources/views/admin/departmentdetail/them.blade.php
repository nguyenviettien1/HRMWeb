                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            <p class="pageheader-text">Add Department</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                @endif
                                    <form id="validationform" action="admin/phongban/them" method="POST">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Tên phòng ban</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" name="description" placeholder="Nhập tên phòng ban" class="form-control">
                                            </div>
                                        </div>
