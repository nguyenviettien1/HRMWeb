                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            ...
                            <div style="width:100%;position: relative;">
                                <a href="admin/nhanvien/them" class="btn btn-primary" style="right: 0 ;position: absolute;">Thêm mới</a>
                            </div>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="admin/nhanvien/danhsach" class="breadcrumb-link">Danh sách</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
