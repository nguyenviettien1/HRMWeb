                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tài khoản</h2>
                            <div style="width:100%;position: relative;">
                                <a href="admin/user/them" class="btn btn-primary" style="right: 0 ;position: absolute;">Thêm mới</a>
                            </div>
                            <p class="pageheader-text">Account</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">Tài khoản</li>
                                        <li class="breadcrumb-item"><a href="admin/user/danhsach" class="breadcrumb-link">Danh sách</a></li>
                                    </ol>
                                </nav>
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-weight:bold; background-color:yellow">UserName</th>
                                                <th style="font-weight:bold; background-color:yellow">Quyền</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$ac->nhanvien->userCD}}</td>
                                                <td>{{$ac->nhanvien->name}}</td>
                                                <td>{{$ac->userName}}</td>
                                                <td>
                                                @if($ac->permission == 1)
                                                    {{"Admin"}}
